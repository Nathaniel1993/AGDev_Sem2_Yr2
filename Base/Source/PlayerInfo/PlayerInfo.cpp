...
void CPlayerInfo::Update(double dt)
{
	...
	//double camera_yaw = mouse_diff_x * 0.5f;		// 3.142 / 180.0
	//double camera_pitch = mouse_diff_y * 0.5f;	// 3.142 / 180.0

	double camera_yaw = mouse_diff_x * 0.0174555555555556 * 10.f;
	double camera_pitch = mouse_diff_y * 0.0174555555555556 * 10.f;
